...
`samples/data` には、上記と同じ考え方で `Data01`、`Data02`、`Data03` の3つのルートフォルダーを同梱しています。
...
例えば `samples/data/Data01` をルートとして開き、`Data01_01/sample002/user.csv` を保存した場合、バックアップは `.backup/Data01/Data01_01/sample002/user.csv.20260614123045.bak` に作成します。
...
`samples/data` 以下に、動作確認用のCSVを同梱しています。
